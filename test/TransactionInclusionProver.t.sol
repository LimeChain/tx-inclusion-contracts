...
contract TransactionInclusionProverTest is BaseTest {
    ...
    function testProveTransactionInclusion2() public {
        ...
        BlockData memory blockData = BlockData({
            parentHash: hex"305ba59e43d9805fe41f1517cf17e5267b64b36aca0507327a987d0081325c59",
            sha3Uncles: hex"1dcc4de8dec75d7aab85b567b6ccd41ad312451b948a7413f0a142fd40d49347",
            miner: hex"388c818ca8b9251b393131c08a736a67ccb19297",
            stateRoot: hex"20df3a1649c181e62de637e9d68aafdfdabd81ddc04d85fee90ed68f9868dfd9",
            transactionsRoot: hex"77a44d58b3717e1c85db71b825f8dbacca242cae2c75c4be1c8565a19b5f1c72",
            receiptsRoot: hex"4383a3e9f188afb16fbbf8419bd90bd3bd1797b93da3b03d4d316ce87a3e1843",
            ...
            mixHash: hex"767dab8d252203fa6c228ea45f14c5783008dfff5eda59d31b1364d8914ec62e",
            nonce: hex"0000000000000000",
            baseFeePerGas: uint256(0xe4618f11b),
            withdrawalsRoot: hex"5b53a1c5fa08ccdd3793c58ba12b85c3526d326880e381c065bbdd5ff07fe7bc"
        });
    ...
    function testProveTransactionInclusionWithStateRootZeroBeginning() public {
        ...
        BlockData memory blockData = BlockData({
            parentHash: hex"1f2274b771312ed973f587848c0e06d43445f92e93acdb52b3ac1b6b008c96a4",
            sha3Uncles: hex"1dcc4de8dec75d7aab85b567b6ccd41ad312451b948a7413f0a142fd40d49347",
            miner: hex"690b9a9e9aa1c9db991c7721a92d351db4fac990",
            stateRoot: hex"0aebc93cd08f5cdbcba648bee33cf61e03b60bc3f424fabd6c0a4221d6426c8d",
            transactionsRoot: hex"90194abd8e79573c61b7a43f48b8e21183b18bd18b054b6d08c19ebd56dc84fa",
            receiptsRoot: hex"109d5c51f422cbbfaf1efe27466ecf9137cdc65be8325d99f4bdfa8123565282",
            ...
            extraData: hex"6275696c64657230783639",
            mixHash: hex"7584fd8ee4124e9780a7079ec94e87a7d21a644345535e79916a8a0216cf8fd8",
            nonce: hex"0000000000000000",
            baseFeePerGas: uint256(0x79e323879),
            withdrawalsRoot: hex"04ac2427e475e8b2f6c8b5bea344b094abde87b0ed987c826be5c3f110689cd4"
        });
        ...
        ReceiptStruct memory txReceipt = ReceiptStruct({
            ...
            bitvector: hex"",
            logs: logs
        });
